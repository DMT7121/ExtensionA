document.addEventListener('DOMContentLoaded', () => {
    ...
    const generateVietQR = () => {
        ...
        // Official VietQR.io template: https://img.vietqr.io/image/<BANK_ID>-<ACCOUNT_NO>-<TEMPLATE>.png
    ...
    qrSaveTemplateBtn.addEventListener('click', () => {
        ...
        // Avoid duplicates: remove existing if same bank/acc
        ...
        qrSavedList.querySelectorAll('.qr-load-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (idx !== -1) {
                    ...
                    // Move to top of list as "most recently used"
                    ...
                    updateCompactView();
                    generateVietQR(); // Automatically generate QR code image
                    toggleQRForm(false);
                }
            });
        });
    ...
    // --- Floating Window ---
    toolFloatBtn.addEventListener('click', () => { chrome.windows.create({ url: chrome.runtime.getURL("popup.html"), type: "popup", width: 395, height: 600 }); });
